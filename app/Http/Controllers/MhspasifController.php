...
class MhspasifController extends Controller
{
    /**
    ...
    public function showSkema($status_id)
    {
        ...
        return view('admin.profilMhsPasifAdmin', compact('skemas', 'status_id', 'total_users_konfirmasi'));
    }
    ...
    public function showPeriode($status_id, $skema_id)
    {
        ...
        $total_users_konfirmasi = User::where('role', 'mahasiswa')->where('is_active', false)->count();
        return view('admin.profilMhsPasifPeriodeAdmin', compact('periodes', 'status_id', 'skema_id', 'total_users_konfirmasi'));
    }
    ...
    public function viewUsers(Request $request, $status_id, $skema_id, $periode_id)
    {
        ...
        return view('admin.getMahasiswaPasif', compact('periode', 'status_id', 'skema_id', 'periode_id', 'users', 'statusModel', 'total_users', 'periodeModel', 'total_users_konfirmasi'));
    }
    ...
    public function detailUser($status_id, $skema_id, $periode_id, $user_id)
    {
        ...
        return view('admin.detail-mahasiswaPasif', compact(
            'status',
            'status_id',
            'skema_id',
            'periode_id',
